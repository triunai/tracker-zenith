...
const MobileMenuDrawer: React.FC<MobileMenuDrawerProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-[300px] sm:w-[350px] p-0 bg-background/40 backdrop-blur-xl supports-[backdrop-filter]:bg-background/30 border-l border-border/30">
        ...
        <div className="px-4 py-4 mt-auto absolute bottom-0 left-0 right-0 bg-background border-t">
          <Button
            variant="destructive"
            size="lg"
